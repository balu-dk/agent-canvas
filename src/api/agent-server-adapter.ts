...
// (see scripts/launch-docker.mjs and scripts/launch-safe.mjs).
...
export function buildRuntimeServicesSystemSuffix(): string | undefined {
  ...
  // different ports across dev modes (18000 in npm run dev -- --no-automation --sandbox none, 8000 in
  // npm run dev, ...), and baking the wrong port into the system prompt
