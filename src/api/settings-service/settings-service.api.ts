...
class SettingsService {
  ...
  static async saveSettings(
    ...
    if (isCloud) {
      ...
      // requires at least one of the two diff fields. Strip disabled_skills and
      // skip the request entirely if no diffs remain. App preferences are
      // persisted to localStorage above.
